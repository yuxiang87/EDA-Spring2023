...
-   **polygons** - also created from a sequence of coordinate pairs, but where the _first and last pair_ are in the same location, thus closing the shape and defining an area. 
...
##1 indicate 1 degree in longitude and latitude
#View the result
mapview(the_buffer)
```
...
The "solution" to these issues involves creating a vast number of different _coordinate reference systems_, each consisting of:
