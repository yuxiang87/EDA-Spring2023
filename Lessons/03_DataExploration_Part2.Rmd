...
> Answer: 
bar plot: comparing differernt category value. river discharge values
histogram: frequency. show how many days of high discharge day in one year.
frequency polygon: frequency and value, trends? one river discharge change.
box-and whisker: summary of value, value compostion. compare rivers discharge.
violin:similar to box and whisker, but count outliers, more smooth?
...
> Answer: 
Different methods are suitable for presenting different information. 
